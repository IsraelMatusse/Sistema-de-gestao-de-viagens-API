...
public class Viajante {
    ...
    */
    ...
    public Viajante(ViajanteCriarDTO dto, Genero genero,  DocumentoIdentifiacacao documentoIdentifiacacao, Provincia provincia, Distrito distrito, Contacto contacto){
